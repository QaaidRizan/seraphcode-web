...
```
background:          #0A0F14      // Deep void black with slight blue undertone
foreground:          #FFFFFF      // Primary text, not pure white (less harsh)
card:                #000000      // Card background, deep purple-black
muted:               #1A1A1A      // UI chrome/elevated backgrounds
mutedForeground:     #D1D5DB      // Secondary text, reduced contrast
accent:              #00F5D4      // PRIMARY NEON - Electric green (Matrix-inspired)
accentSecondary:     #A56CFF      // SECONDARY NEON - Hot magenta/pink
accentTertiary:      #6FE7FF      // TERTIARY NEON - Cyan/electric blue
border:              #163040      // Subtle borders
input:               #000000      // Deep input background
ring:                #00F5D4      // Focus ring matches accent
...
--box-shadow-neon: 0 0 5px #00F5D4, 0 0 10px #00F5D440;

/* Small neon glow - subtle accents */
--box-shadow-neon-sm: 0 0 3px #00F5D4, 0 0 6px #00F5D430;

/* Large neon glow - emphasized states, hero elements */
--box-shadow-neon-lg: 0 0 10px #00F5D4, 0 0 20px #00F5D460, 0 0 40px #00F5D430;

/* Secondary neon (magenta) */
--box-shadow-neon-secondary: 0 0 5px #A56CFF, 0 0 20px #A56CFF60;

/* Tertiary neon (cyan) */
--box-shadow-neon-tertiary: 0 0 5px #6FE7FF, 0 0 20px #6FE7FF60;
```

**Text Shadows for Depth**:
```css
/* Glitch effect text shadow (used on hero headline) */
drop-shadow: 0 0 10px rgba(0, 245, 212, 0.5);
...
- text-shadow: -1px 0 #A56CFF (magenta left)
- text-shadow: -1px 0 #6FE7FF (cyan right)
...
- Border: 2px solid accent (#00F5D4)
- Text: accent color
...
**Secondary Variant**:
```
- Border: 2px solid accentSecondary (#A56CFF)
...
**Outline Variant**:
```
- Border: 1px solid border (#163040)
- Background: transparent
...
**Glitch Variant** (CTAs):
```
- Background: solid accent (#00F5D4)
...
```
- Background: background (#0A0F14) instead of card
...
```
- Background: glass (#1F2937) at 30% opacity
...
@keyframes rgbShift {
  0%, 100% { text-shadow: -2px 0 #A56CFF, 2px 0 #6FE7FF; }
  50% { text-shadow: 2px 0 #A56CFF, -2px 0 #6FE7FF; }
}
```
